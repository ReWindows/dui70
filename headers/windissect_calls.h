...
static constexpr wchar_t module_name[10] = {0x0044, 0x0055, 0x0049, 0x0037, 0x0030, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 1031091332U || rva >= image_size) return nullptr;
return base + rva;
}

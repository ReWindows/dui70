//! Windissect-generated Rust FFI bindings for DUI70.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "F1920C0ED3DE254FE969E8E8CC4435CE";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1031091332;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 10] = [68, 85, 73, 55, 48, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1031091332 { return 0; }
